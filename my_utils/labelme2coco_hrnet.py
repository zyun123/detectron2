...
class labelme2coco(object):
    ...
    def build_bbox(self, img):
        ...
        bbox = [1,1,img.shape[1]-2,img.shape[0]-2]
        return bbox
...
if __name__ == "__main__":
    ...
    baseDir = "/911G/data/temp/20221229新加手托脚托新数据/精确标注494套middle_up_nei_changerec/hrnet_data_rotate_90/"
    EightModelList = [
