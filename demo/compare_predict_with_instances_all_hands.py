"""
将训练的合并的4个手部数据模型  局部图局部模型 用于预测验证集，统计两者欧氏距离
"""
...
if __name__ == "__main__":
    ...
    # jl_names_test = ALLJL_UP_LEFT_HAND
    jl_names_pred = ["L-xinbao-5","L-xinbao-6","L-xinbao-7","L-xinbao-8","L-xinbao-9","R-xinbao-5","R-xinbao-6","R-xinbao-7","R-xinbao-8","R-xinbao-9","L-xin-4","L-xin-5","L-xin-6","R-xin-4","R-xin-5","R-xin-6","L-fei-6","L-fei-7","L-fei-8","R-fei-6","R-fei-7","R-fei-8","L-sanjiao-1","L-sanjiao-2","L-sanjiao-3","R-sanjiao-1","R-sanjiao-2","R-sanjiao-3","L-xiaochang-1","L-xiaochang-2","L-xiaochang-3","R-xiaochang-1","R-xiaochang-2","R-xiaochang-3","L-dachang-1","L-dachang-2","L-dachang-3","L-dachang-4","R-dachang-1","R-dachang-2","R-dachang-3","R-dachang-4"]
    # pred_dir = "/911G/data/new_all_jldata/20230410/middle_up_nei/test_crop/left_hand(merge4hands)"
    # test_dir = "/911G/data/new_all_jldata/20230410/middle_up_nei/test_crop/left_hand"

    # #middle up nei right hand
    jl_names_test = ALLJL_UP_RIGHT_HAND
    pred_dir = "/911G/data/new_all_jldata/20230410/middle_up_nei/test_crop/right_hand(merge4hands)"
    test_dir = "/911G/data/new_all_jldata/20230410/middle_up_nei/test_crop/right_hand"

    # #middle down wai left hand
    # jl_names_test = ["L-sanjiao-1", "L-sanjiao-2", "L-sanjiao-3"]
    # jl_names_test = ALLJL_DOWN_LEFT_HAND
    # pred_dir = "/911G/data/new_all_jldata/20230410/middle_down_wai/test_crop/left_hand(merge4hands)"
    # test_dir = "/911G/data/new_all_jldata/20230410/middle_down_wai/test_crop/left_hand"

    # #middle down wai right hand
    # jl_names_test = ["R-sanjiao-1", "R-sanjiao-2", "R-sanjiao-3"]
    # jl_names_test = ALLJL_DOWN_RIGHT_HAND
    # pred_dir = "/911G/data/new_all_jldata/20230410/middle_down_wai/test_crop/right_hand(merge4hands)"
    ...
    for file in file_list:
        if file.endswith("json"):
            ...
            pred_kp = get_kp_with_instances(pred_js_file,jl_names_pred)
            test_kp = get_kp_with_instances(test_js_file,jl_names_test)


            #需要将pred_kp 和 test_kp的顺序
            kp_index = [ jl_names_pred.index(name) for name in jl_names_test]
            pred_kp = pred_kp[kp_index]
