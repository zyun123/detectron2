"""
将训练的合并的4个手部数据模型,合并左右标签  局部图局部模型 用于预测验证集，统计两者欧氏距离
"""
...
if __name__ == "__main__":
    ...
    jl_names_pred = ["xinbao-5","xinbao-6","xinbao-7","xinbao-8","xinbao-9","xin-4","xin-5","xin-6","fei-6","fei-7","fei-8","sanjiao-1","sanjiao-2","sanjiao-3"]
    # pred_dir = "/911G/data/new_all_jldata/20231226/middle_up_nei/test_crop/left_hand(mergeLRlabels)"
    ...
    pred_dir = "/911G/data/new_all_jldata/20231226/middle_up_nei/test_crop/right_hand(mergeLRlabels)"
    ...
    # pred_dir = "/911G/data/new_all_jldata/20230410/middle_down_wai/test_crop/left_hand(mergeLRlabels)"
    ...
    # pred_dir = "/911G/data/new_all_jldata/20230410/middle_down_wai/test_crop/right_hand(mergeLRlabels)"
    ...
    for file in file_list:
        if file.endswith("json"):
            ...
            kp_index = [ jl_names_pred.index(name[2:]) for name in jl_names_test]
